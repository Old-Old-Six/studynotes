...
<span class="line"><span>npm run dev</span></span></code></pre></div><p>启动后会生成packages\\vue\\dist\\vue.global.js，这个文件为实时更新的源码打包文件，我们调试源码需要引入这个文件</p><p><img src="`+e+`" alt=""></p><h2 id="_2-创建study-myvue-vue文件" tabindex="-1">2.创建study/myVue.vue文件 <a class="header-anchor" href="#_2-创建study-myvue-vue文件" aria-label="Permalink to &quot;2.创建study/myVue.vue文件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script src=&quot;../../dist/vue.global.js&quot;&gt;&lt;/script&gt;</span></span>
<span class="line"><span></span></span>
